 ...
 */
template <class PointT, class NormalT> class LBOEstimation {
public:
  ...
  void setInputCloud(const InputCloudPtr &cloud) { _cloud = cloud; }

  void setCloudNormals(const NormalCloudPtr &normals) { _normals = normals; }
